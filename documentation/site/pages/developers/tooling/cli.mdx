...
Deposits USDC into the market as collateral (USDC is used for collateral in Boundless):
...
This deposits 100 USDC into your collateral balance.


#### withdraw-collateral

Withdraws collateral USDC from the market:
...
Checks the current collateral USDC balance for a given address (defaults to your address if none given):
...
offer:
    ...
    lockCollateral: 5000000 # 5 USDC tokens
```
