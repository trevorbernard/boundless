...
The Boundless governance contracts have been deployed by Aragon at `TODO’.
:::

### Voting Power & Staking

To be eligible to vote in the Boundless DAO, token holders must stake $ZKC; voting power is relative to the percentage of total staked $ZKC i.e. an addess that stakes 1% of the total staked $ZKC will possess 1% of the total voting power.

### What does governance control?

With the launch of ZKC, the DAO is going through a set of test proposals to ensure that each governance process is fully functional. Once these are successfull, the DAO will be given full ownership of the protocol.
