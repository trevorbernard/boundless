...
After claiming staking + mining rewards, the *$ZKC* rewards contract will carry out the necessary checks, and if successful, mint the rewards to the rewards address.
