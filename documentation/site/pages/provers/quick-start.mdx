...
- Please check the [Proving Leaderboard](https://mining.beboundless.xyz/leaderboard) here for more details.
:::
...
:::note[Note]
* To read more about depositing funds to the market, please see [Deposit / Balance](/provers/broker#deposit-collateral-to-the-market).
* If you need testnet USDC on Base Sepolia, please use the [Circle Testnet Faucet](https://faucet.circle.com/).
:::

With the environment variables set, you can now deposit USDC tokens as collateral to your account balance:
