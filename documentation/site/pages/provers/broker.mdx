...
The Boundless market requires funds (USDC) deposited as collateral before a prover can bid on requests.
...
boundless account deposit-collateral <USDC_TO_DEPOSIT>
```
