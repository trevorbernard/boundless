...
export class OrderStreamPipeline extends pulumi.ComponentResource {
  constructor(name: string, args: OrderStreamPipelineArgs, opts?: pulumi.ComponentResourceOptions) {
