const logGroupMapping = (service: string): string => {
  switch (service) {
    case 'bento-prover':
      return 'l-prod-11155111-bento-prover-11155111';
    case 'bonsai-prover':
    ...
    case 'og-offchain':
      return 'l-prod-11155111-og-offchain-11155111';
    case 'og-onchain':
      return 'l-prod-11155111-og-onchain-11155111';
    case 'order-stream':
      return 'l-prod-11155111-order-stream';
    case 'order-slasher':
      return 'l-prod-11155111-order-slasher-11155111';
    default:
      console.log(`No log group name found for service: ${service}. Attempting to infer from service name.`);
      return `l-prod-11155111-${service}-11155111`;
  }
}
